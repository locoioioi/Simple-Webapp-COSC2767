...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron">
      <h1 class="display-4">[Live Coding at tutorial, Hi Class] Hello DevOps Students of RMIT Vietnam!!</h1>
      <p class="lead">This is a very simple website template that uses bootstrap CSS framework! and my name is Loc</p>
